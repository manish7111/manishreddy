...
using System;
/// <summary>
/// ServerFactory is a class which implements abstract class ComputerFactory.
/// </summary>
public class ServerFactory : ComputerFactory
{
    /// <summary>
    /// The ram
    /// </summary>
    ...
    public ServerFactory(string _ram, string _hdd, string _cpu)
    {
        ram = _ram;
        hdd = _hdd;
        cpu = _cpu;
